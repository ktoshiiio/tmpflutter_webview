...
class PlatformWebStorageCreationParams {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorage.localStorage}
  final PlatformLocalStorage localStorage;

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorage.sessionStorage}
  final PlatformSessionStorage sessionStorage;
}

///{@template tmpflutter_webview_platform_interface.PlatformWebStorage}
...
abstract class PlatformWebStorage extends PlatformInterface
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebStorage.localStorage}
  ///Represents `window.localStorage`.
  ///{@endtemplate}
  PlatformLocalStorage get localStorage => params.localStorage;

  ///{@template tmpflutter_webview_platform_interface.PlatformWebStorage.sessionStorage}
  ///Represents `window.sessionStorage`.
  ///{@endtemplate}
  PlatformSessionStorage get sessionStorage => params.sessionStorage;

  ///{@template tmpflutter_webview_platform_interface.PlatformWebStorage.dispose}
...
class PlatformStorageCreationParams {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.controller}
  final PlatformInAppWebViewController? controller;

  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.webStorageType}
  final WebStorageType webStorageType;
}

///{@template tmpflutter_webview_platform_interface.PlatformStorage}
...
abstract class PlatformStorage implements Disposable {
  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.controller}
  ///Controller used to interact with storage.
  ///{@endtemplate}
  PlatformInAppWebViewController? get controller;

  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.webStorageType}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.length}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.setItem}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.getItem}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.removeItem}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.getItems}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.clear}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformStorage.key}
...
///{@template tmpflutter_webview_platform_interface.PlatformLocalStorage}
...
///{@template tmpflutter_webview_platform_interface.PlatformSessionStorage}
