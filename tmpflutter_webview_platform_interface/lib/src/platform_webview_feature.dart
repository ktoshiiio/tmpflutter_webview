...
///{@template tmpflutter_webview_platform_interface.PlatformWebViewFeature}
...
abstract class PlatformWebViewFeature extends PlatformInterface {
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebViewFeature.isFeatureSupported}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebViewFeature.isStartupFeatureSupported}
...
///{@macro tmpflutter_webview_platform_interface.PlatformWebViewFeature}
@ExchangeableEnum()
class WebViewFeature_ {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformWebViewFeature.isFeatureSupported}
  static Future<bool> isFeatureSupported(WebViewFeature feature) =>
      PlatformWebViewFeature.static().isFeatureSupported(feature);

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebViewFeature.isStartupFeatureSupported}
