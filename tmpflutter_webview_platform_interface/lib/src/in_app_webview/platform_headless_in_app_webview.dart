...
///{@template tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView}
...
abstract class PlatformHeadlessInAppWebView extends PlatformInterface
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.id}
  ///View ID.
  ///{@endtemplate}
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.webViewController}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.run}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.isRunning}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.setSize}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.getSize}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.dispose}
