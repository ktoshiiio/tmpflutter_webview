...
class PlatformPullToRefreshControllerCreationParams {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformPullToRefreshController.options}
  @Deprecated("Use settings instead")
  late PullToRefreshOptions options;

  ///{@macro tmpflutter_webview_platform_interface.PlatformPullToRefreshController.settings}
  late PullToRefreshSettings settings;

  ///{@macro tmpflutter_webview_platform_interface.PlatformPullToRefreshController.onRefresh}
  final void Function()? onRefresh;
}

///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController}
...
abstract class PlatformPullToRefreshController extends PlatformInterface
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.options}
  /// Use [settings] instead.
  ///{@endtemplate}
  @Deprecated("Use settings instead")
  PullToRefreshOptions get options => params.options;

  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.settings}
  /// Initial settings.
  ///{@endtemplate}
  PullToRefreshSettings get settings => params.settings;

  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.onRefresh}
  ///Event called when a swipe gesture triggers a refresh.
  ///{@endtemplate}
  void Function()? get onRefresh => params.onRefresh;

  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setEnabled}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.isEnabled}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.beginRefreshing}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.endRefreshing}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.isRefreshing}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setColor}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setBackgroundColor}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setDistanceToTriggerSync}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setSlingshotDistance}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.getDefaultSlingshotDistance}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setSize}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setIndicatorSize}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setAttributedTitle}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.setStyledTitle}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPullToRefreshController.dispose}
