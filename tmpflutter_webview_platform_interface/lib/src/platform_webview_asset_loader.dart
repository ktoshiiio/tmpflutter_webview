...
class PlatformPathHandlerCreationParams {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformPathHandler.path}
  final String path;
}

///{@template tmpflutter_webview_platform_interface.PlatformPathHandler}
...
abstract class PlatformPathHandler {
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPathHandler.type}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformPathHandler.path}
...
abstract class PlatformPathHandlerEvents {
  ///{@template tmpflutter_webview_platform_interface.PlatformPathHandler.handle}
...
///{@template tmpflutter_webview_platform_interface.PlatformAssetsPathHandler}
...
///{@template tmpflutter_webview_platform_interface.PlatformResourcesPathHandler}
...
///{@template tmpflutter_webview_platform_interface.PlatformInternalStoragePathHandler}
