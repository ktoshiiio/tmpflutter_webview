...
///{@template tmpflutter_webview_platform_interface.PlatformInAppLocalhostServer}
...
abstract class PlatformInAppLocalhostServer extends PlatformInterface {
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformInAppLocalhostServer.port}
  ///Represents the port of the server. The default value is `8080`.
  ///{@endtemplate}
  int get port => params.port;

  ///{@template tmpflutter_webview_platform_interface.PlatformInAppLocalhostServer.directoryIndex}
  ///represents the index file to use. The default value is `index.html`.
  ///{@endtemplate}
  String get directoryIndex => params.directoryIndex;

  ///{@template tmpflutter_webview_platform_interface.PlatformInAppLocalhostServer.documentRoot}
  ///Represents the document root path to serve. The default value is `./`.
  ///{@endtemplate}
  String get documentRoot => params.documentRoot;

  ///{@template tmpflutter_webview_platform_interface.PlatformInAppLocalhostServer.shared}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformInAppLocalhostServer.start}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformInAppLocalhostServer.close}
  ///Closes the server.
  ///{@endtemplate}
  Future<void> close() {
    throw UnimplementedError(
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformInAppLocalhostServer.isRunning}
