...
class PlatformWebMessageChannelCreationParams {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformWebMessageChannel.id}
  final String id;

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebMessageChannel.port1}
  final PlatformWebMessagePort port1;

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebMessageChannel.port2}
...
///{@template tmpflutter_webview_platform_interface.PlatformWebMessageChannel}
...
abstract class PlatformWebMessageChannel extends PlatformInterface
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebMessageChannel.id}
  ///Message Channel ID used internally.
  ///{@endtemplate}
  String get id => params.id;

  ///{@template tmpflutter_webview_platform_interface.PlatformWebMessageChannel.port1}
  ///The first [PlatformWebMessagePort] object of the channel.
  ///{@endtemplate}
  PlatformWebMessagePort get port1 => params.port1;

  ///{@template tmpflutter_webview_platform_interface.PlatformWebMessageChannel.port2}
