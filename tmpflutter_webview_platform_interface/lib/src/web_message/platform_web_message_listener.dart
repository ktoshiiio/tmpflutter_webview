...
///{@template tmpflutter_webview_platform_interface.PlatformWebMessageListener}
...
abstract class PlatformWebMessageListener extends PlatformInterface
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebMessageListener.jsObjectName}
  ///The name for the injected JavaScript object.
  ///{@endtemplate}
  String get jsObjectName => params.jsObjectName;

  ///{@template tmpflutter_webview_platform_interface.PlatformWebMessageListener.allowedOriginRules}
  ///A set of matching rules for the allowed origins.
  ///{@endtemplate}
  Set<String>? get allowedOriginRules => params.allowedOriginRules;

  ///{@template tmpflutter_webview_platform_interface.PlatformWebMessageListener.onPostMessage}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebMessageListener.dispose}
...
///{@template tmpflutter_webview_platform_interface.PlatformJavaScriptReplyProxy}
...
abstract class PlatformJavaScriptReplyProxy extends PlatformInterface {
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformJavaScriptReplyProxy.postMessage}
