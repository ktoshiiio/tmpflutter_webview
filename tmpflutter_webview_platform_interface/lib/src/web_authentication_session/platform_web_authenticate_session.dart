...
///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession}
...
abstract class PlatformWebAuthenticationSession extends PlatformInterface
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.id}
  ///ID used internally.
  ///{@endtemplate}
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.url}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.callbackURLScheme}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.initialSettings}
  ///Initial settings.
  ///{@endtemplate}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.onComplete}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.create}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.canStart}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.start}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.cancel}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.dispose}
  ...
  ///{@template tmpflutter_webview_platform_interface.PlatformWebAuthenticationSession.isAvailable}
