...
///{@macro tmpflutter_webview_platform_interface.PlatformProxyController}
class ProxyController {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformProxyController.setProxyOverride}
  Future<void> setProxyOverride({required ProxySettings settings}) =>
      platform.setProxyOverride(settings: settings);

  ///{@macro tmpflutter_webview_platform_interface.PlatformProxyController.clearProxyOverride}
