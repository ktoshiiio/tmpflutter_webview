...
///{@macro tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView}
class HeadlessInAppWebView {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.id}
  String get id => platform.id;

  ///{@macro tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.webViewController}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.isRunning}
  bool isRunning() => platform.isRunning();

  ///{@macro tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.setSize}
  Future<void> setSize(Size size) => platform.setSize(size);

  ///{@macro tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.getSize}
  Future<Size?> getSize() => platform.getSize();

  ///{@macro tmpflutter_webview_platform_interface.PlatformHeadlessInAppWebView.dispose}
