...
///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser}
class ChromeSafariBrowser implements PlatformChromeSafariBrowserEvents {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.id}
  String get id => platform.id;

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.open}
  Future<void> open(
          {WebUri? url,
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.launchUrl}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.mayLaunchUrl}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.validateRelationship}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.close}
  Future<void> close() => platform.close();

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.isOpened}
  bool isOpened() => platform.isOpened();

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.setActionButton}
  void setActionButton(ChromeSafariBrowserActionButton actionButton) =>
      platform.setActionButton(actionButton);

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.updateActionButton}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.setSecondaryToolbar}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.updateSecondaryToolbar}
  Future<void> updateSecondaryToolbar(
          ChromeSafariBrowserSecondaryToolbar secondaryToolbar) =>
      platform.updateSecondaryToolbar(secondaryToolbar);

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.addMenuItem}
  void addMenuItem(ChromeSafariBrowserMenuItem menuItem) =>
      platform.addMenuItem(menuItem);

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.addMenuItems}
  void addMenuItems(List<ChromeSafariBrowserMenuItem> menuItems) =>
      platform.addMenuItems(menuItems);

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.requestPostMessageChannel}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.postMessage}
  Future<CustomTabsPostMessageResultType> postMessage(String message) =>
      platform.postMessage(message);

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.isEngagementSignalsApiAvailable}
  Future<bool> isEngagementSignalsApiAvailable() =>
      platform.isEngagementSignalsApiAvailable();

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.isAvailable}
  static Future<bool> isAvailable() =>
      PlatformChromeSafariBrowser.static().isAvailable();

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.getMaxToolbarItems}
  static Future<int> getMaxToolbarItems() =>
      PlatformChromeSafariBrowser.static().getMaxToolbarItems();

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.getPackageName}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.clearWebsiteData}
  static Future<void> clearWebsiteData() =>
      PlatformChromeSafariBrowser.static().clearWebsiteData();

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.prewarmConnections}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.invalidatePrewarmingToken}
  static Future<void> invalidatePrewarmingToken(
          PrewarmingToken prewarmingToken) =>
      PlatformChromeSafariBrowser.static()
          .invalidatePrewarmingToken(prewarmingToken);

  ///{@macro tmpflutter_webview_platform_interface.PlatformChromeSafariBrowser.dispose}
  @mustCallSuper
