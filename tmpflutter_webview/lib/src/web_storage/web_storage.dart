...
///{@macro tmpflutter_webview_platform_interface.PlatformWebStorage}
class WebStorage {
  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorage}
  WebStorage(
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorage.dispose}
  void dispose() => platform.dispose();
}

///{@macro tmpflutter_webview_platform_interface.PlatformStorage}
abstract class Storage implements PlatformStorage {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.length}
  Future<int?> length() => platform.length();

  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.setItem}
  Future<void> setItem({required String key, required dynamic value}) =>
      platform.setItem(key: key, value: value);

  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.getItem}
  Future<dynamic> getItem({required String key}) => platform.getItem(key: key);

  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.removeItem}
  Future<void> removeItem({required String key}) =>
      platform.removeItem(key: key);

  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.getItems}
  Future<List<WebStorageItem>> getItems() => platform.getItems();

  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.clear}
  Future<void> clear() => platform.clear();

  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.key}
  Future<String> key({required int index}) => platform.key(index: index);

  ///{@macro tmpflutter_webview_platform_interface.PlatformStorage.dispose}
  void dispose() => platform.dispose();
}

///{@macro tmpflutter_webview_platform_interface.PlatformLocalStorage}
...
///{@macro tmpflutter_webview_platform_interface.PlatformSessionStorage}
