...
///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager}
class WebStorageManager {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager.getOrigins}
  Future<List<WebStorageOrigin>> getOrigins() => platform.getOrigins();

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager.deleteAllData}
  Future<void> deleteAllData() => platform.deleteAllData();

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager.deleteOrigin}
  Future<void> deleteOrigin({required String origin}) =>
      platform.deleteOrigin(origin: origin);

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager.getQuotaForOrigin}
  Future<int> getQuotaForOrigin({required String origin}) =>
      platform.getQuotaForOrigin(origin: origin);

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager.getUsageForOrigin}
  Future<int> getUsageForOrigin({required String origin}) =>
      platform.getUsageForOrigin(origin: origin);

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager.fetchDataRecords}
  Future<List<WebsiteDataRecord>> fetchDataRecords(
          {required Set<WebsiteDataType> dataTypes}) =>
      platform.fetchDataRecords(dataTypes: dataTypes);

  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager.removeDataFor}
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformWebStorageManager.removeDataModifiedSince}
