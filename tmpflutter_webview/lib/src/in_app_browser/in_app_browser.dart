...
// ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser}
...
//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.id}
...
//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.webViewController}
...
//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.openUrlRequest}
...
//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.openFile}
...
//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.openData}
...
//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.openWithSystemBrowser}
//   static Future<void> openWithSystemBrowser({required WebUri url}) =>
//       PlatformInAppBrowser.static().openWithSystemBrowser(url: url);

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.addMenuItem}
//   void addMenuItem(InAppBrowserMenuItem menuItem) =>
//       platform.addMenuItem(menuItem);

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.addMenuItems}
//   void addMenuItems(List<InAppBrowserMenuItem> menuItems) =>
//       platform.addMenuItems(menuItems);

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.removeMenuItem}
//   bool removeMenuItem(InAppBrowserMenuItem menuItem) =>
//       platform.removeMenuItem(menuItem);

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.removeMenuItems}
//   void removeMenuItems(List<InAppBrowserMenuItem> menuItems) =>
//       platform.removeMenuItems(menuItems);

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.removeAllMenuItem}
//   void removeAllMenuItem() => platform.removeAllMenuItem();

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.hasMenuItem}
//   bool hasMenuItem(InAppBrowserMenuItem menuItem) =>
//       platform.hasMenuItem(menuItem);

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.show}
//   Future<void> show() => platform.show();

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.hide}
//   Future<void> hide() => platform.hide();

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.close}
//   Future<void> close() => platform.close();

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.isHidden}
//   Future<bool> isHidden() => platform.isHidden();

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.setOptions}
//   @Deprecated('Use setSettings instead')
//   Future<void> setOptions({required InAppBrowserClassOptions options}) =>
//       platform.setOptions(options: options);

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.getOptions}
//   @Deprecated('Use getSettings instead')
//   Future<InAppBrowserClassOptions?> getOptions() => platform.getOptions();

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.setSettings}
//   Future<void> setSettings({required InAppBrowserClassSettings settings}) =>
//       platform.setSettings(settings: settings);

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.getSettings}
//   Future<InAppBrowserClassSettings?> getSettings() => platform.getSettings();

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.isOpened}
//   bool isOpened() => platform.isOpened();

//   ///{@macro tmpflutter_webview_platform_interface.PlatformInAppBrowser.dispose}
//   @mustCallSuper
