...
///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController}
class ServiceWorkerController {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.serviceWorkerClient}
  ServiceWorkerClient? get serviceWorkerClient => platform.serviceWorkerClient;

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.setServiceWorkerClient}
  setServiceWorkerClient(ServiceWorkerClient? value) =>
      platform.setServiceWorkerClient(value);

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.getAllowContentAccess}
  static Future<bool> getAllowContentAccess() =>
      PlatformServiceWorkerController.static().getAllowContentAccess();

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.getAllowFileAccess}
  static Future<bool> getAllowFileAccess() =>
      PlatformServiceWorkerController.static().getAllowFileAccess();

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.getBlockNetworkLoads}
  static Future<bool> getBlockNetworkLoads() =>
      PlatformServiceWorkerController.static().getBlockNetworkLoads();

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.getCacheMode}
  static Future<CacheMode?> getCacheMode() =>
      PlatformServiceWorkerController.static().getCacheMode();

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.setAllowContentAccess}
  static Future<void> setAllowContentAccess(bool allow) =>
      PlatformServiceWorkerController.static().setAllowContentAccess(allow);

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.setAllowFileAccess}
  static Future<void> setAllowFileAccess(bool allow) =>
      PlatformServiceWorkerController.static().setAllowFileAccess(allow);

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.setBlockNetworkLoads}
  static Future<void> setBlockNetworkLoads(bool flag) =>
      PlatformServiceWorkerController.static().setBlockNetworkLoads(flag);

  ///{@macro tmpflutter_webview_platform_interface.PlatformServiceWorkerController.setCacheMode}
