...
///{@macro tmpflutter_webview_platform_interface.PlatformTracingController}
class TracingController {
  ...
  ///{@macro tmpflutter_webview_platform_interface.PlatformTracingController.start}
  Future<void> start({required TracingSettings settings}) =>
      platform.start(settings: settings);

  ///{@macro tmpflutter_webview_platform_interface.PlatformTracingController.stop}
  Future<bool> stop({String? filePath}) => platform.stop(filePath: filePath);

  ///{@macro tmpflutter_webview_platform_interface.PlatformTracingController.isTracing}
